...
type FibonacciClient interface {
	FiboCount(ctx context.Context, in *FiboRequest, opts ...grpc.CallOption) (*FiboResponse, error)
}
...
func (c *fibonacciClient) FiboCount(ctx context.Context, in *FiboRequest, opts ...grpc.CallOption) (*FiboResponse, error) {
	out := new(FiboResponse)
	err := c.cc.Invoke(ctx, "/Fibonacci/FiboCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServer interface {
	FiboCount(context.Context, *FiboRequest) (*FiboResponse, error)
...
func (UnimplementedFibonacciServer) FiboCount(context.Context, *FiboRequest) (*FiboResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FiboCount not implemented")
}
...
func _Fibonacci_FiboCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FiboRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FibonacciServer).FiboCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Fibonacci/FiboCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).FiboCount(ctx, req.(*FiboRequest))
	}
...
var Fibonacci_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FiboCount",
			Handler:    _Fibonacci_FiboCount_Handler,
		},
	},
